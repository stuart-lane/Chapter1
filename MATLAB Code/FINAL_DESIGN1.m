%%% AUTHOR:  STUART LANE
%%% DATE:    07/06/2023 
%%% CHAPTER: OVERIDENTIFICATION TESTING WITH WEAK INSTRUMENTS AND HETERO-
%%%          SKEDASTICITY 
%%% CONTENT: FIGURE 5.1, FIGURE B.1
...
for Kj = 1:length(Kvals)
    ...
    for rhoj = 1:length(rhovals)
        ...
        for mu2j = 1:length(mu2a)
            ...
            for alphaj = 1:length(alphaa)
                ...
                parfor rep = 1:Nrep
                       ...
                       kpsample = fun_kpcal(z,z2,piliml,uliml);

                       score2sls = fun_kpcal(z,z2,pi2sls,u2sls);           

                       sb(rep,mu2j,alphaj,:) = [b2sls bliml score2sls kpsample];
                end
        ...
        rhoname = rho*100;
        filenamefig = "C:\Users\sl14120\OneDrive - University of Bristol\PhD\MATLAB Code\Paper1\Final\NEWFINAL\Design1Graphs\" + "D1" + "rejfreqkz" + K  + "rho0" + rhoname + ".fig";
        saveas(gcf,filenamefig,'fig')
